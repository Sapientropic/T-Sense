...
DESK_ACTIONS: tuple[dict, ...] = (
    {
        ...
        "detail": "Create the private local settings and market-news starter list Signal Desk uses for scans.",
        "run_mode": "execute",
        "display_command": "tgcs init",
        "argv": ["init"],
    ...
    },
    {
        ...
        "run_mode": "execute",
        "display_command": "tgcs doctor --profile market-news",
        "argv": ["doctor", "--profile", "market-news", "--format", "json"],
    ...
    },
    {
        ...
        "detail": "Refresh the packaged public market-news starter source list.",
        "run_mode": "execute",
        "display_command": "tgcs sources import channel_lists/market-news.txt --topic market-news",
        "argv": ["sources", "import", "channel_lists/market-news.txt", "--topic", "market-news", "--format", "json"],
    ...
    },
    {
        ...
        "run_mode": "execute",
        "display_command": "tgcs monitor run --profile-id market-news --delivery-mode live",
        "argv": [
            "monitor",
            "run",
            "--profile-id",
    ...
    },
    {
        ...
        "run_mode": "execute",
        "display_command": "tgcs schedule print --profile-id market-news --interval-minutes 15 --delivery-mode live",
        "argv": [
            "schedule",
            "print",
            "--profile-id",
...
def _desk_action_success_copy(action_id: str, fallback: str) -> str:
    return {
        "demo_render": "Demo report ready. Open it to see the kind of review Signal Desk will produce with your own sources.",
